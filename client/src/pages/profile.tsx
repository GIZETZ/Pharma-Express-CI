      ...
      <div className="px-4 py-6">
        <Card className="shadow-sm mb-6">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-2xl font-bold text-pharma-green" data-testid="text-orders-count">
                  12
                </p>
                <p className="text-gray-600 text-sm">Commandes</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-pharma-green" data-testid="text-savings-amount">
                  2,450
                </p>
                <p className="text-gray-600 text-sm">CFA économisés</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-pharma-green" data-testid="text-loyalty-points">
                  850
                </p>
        ...
        <div className="space-y-4">
          ...
          <Card className="shadow-sm overflow-hidden">
            ...
            <button className="w-full px-4 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors" data-testid="button-help-center">
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-pharma-green" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button className="w-full px-4 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors" data-testid="button-contact-support">
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-pharma-green" fill="currentColor" viewBox="0 0 20 20">
