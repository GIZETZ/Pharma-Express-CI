  ...
  return (
    <div className="min-h-screen bg-pharma-bg pb-20">
      ...
      <div className="px-4 py-6">
        <div className="bg-gradient-to-r from-green-100 to-green-200 border-2 border-green-300 rounded-2xl p-6 mb-6 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-xl font-semibold text-green-800" data-testid="text-delivery-status">
                {currentOrder?.status === 'in_delivery' ? 'En cours de livraison' : 'Suivi de commande'}
              </h2>
              <p className="text-green-700" data-testid="text-order-number">
